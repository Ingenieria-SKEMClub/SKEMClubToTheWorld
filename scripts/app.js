...
function changeColor() {
  ...
  let img = [
    "<img class='img' src='/IMG/Personajes2_Artista.png' > </img>",
    "<img   class='img' src='/IMG/Personajes2_Cientifica.png' ></img>",
    "<img class='img' src='/IMG/Personajes2_Ing.png'></img>",
    "<img class='img' src='/IMG/Personajes2_Eco.png'></img>",
    "<img class='img' src='/IMG/Personajes2_Lider.png'></img>",
  ];
  let shadow = [
